...
export async function sendResetPasswordEmail(
  ...
  const frontendUrl = getLocalIpAddress();
 ...
 */
export async function sendMobileLoginApprovalEmail(
  email: string,
  name: string,
  token: string
) {
 ...
 */
export async function sendWorkerEmailVerificationOtp(
  email: string,
  name: string,
  otp: string
) {
 ...
 */
export async function sendWorkerWelcomeCredentialsEmail(
  email: string,
  name: string,
  employeeCode: string,
  password: string
